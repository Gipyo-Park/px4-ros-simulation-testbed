...
% 데이터 불러오기
flight_data = readtable('/home/hmcl/PX4_testbed/octocopter_matlab/drone_metric_matlab/flight_data_for_agressive_maneuver.csv');
...
Mx_data = flight_data(:, {'p', 'u_p', 'Mx'});
My_data = flight_data(:, {'q', 'u_q', 'My'});
Mz_data = flight_data(:, {'r', 'u_r', 'Mz'});
