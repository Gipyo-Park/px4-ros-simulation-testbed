...
if [ "$motor_failure_number" -ne 0 ]; then
    ...
    open_terminal_tab "$motor_failure_command" "Publish Motor Failure with FTC"
    sleep 3
fi
...
if [ "$motor_failure_number1" -ne 0 ]; then
    ...
    open_terminal_tab "$motor_failure_command1" "Publish Motor Failure_1 with FTC"
    sleep 3
fi
...
if [ "$motor_failure_number2" -ne 0 ]; then
    ...
    open_terminal_tab "$motor_failure_command2" "Publish Motor Failure_2 with FTC"
    sleep 3
fi
...
if [ "$motor_failure_number3" -ne 0 ]; then
    ...
    open_terminal_tab "$motor_failure_command3" "Publish Motor Failure_3 with FTC"
    sleep 3
fi
...
if [ "$motor_failure_number4" -ne 0 ]; then
    ...
    open_terminal_tab "$motor_failure_command4" "Publish Motor Failure_4 with FTC"
    sleep 3
fi
